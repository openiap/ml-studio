    ...
    <EasyDataTable :headers="headers" :items="items" :loading="loading" :server-items-length="serverItemsLength"
      ...
      <template #item-operation="item">
        <div class="operation-wrapper">
          <img v-if="item.href != '' && item.href != null" src="./images/link.png" class="operation-icon" @click="openlinkItem(item)" />
          <img v-if="collectionname=='fs.files'" src="./images/download.png" class="operation-icon" @click="downloadFile(item)" />
...
export default {
  ...
  methods: {
    ...
    async downloadFile(item) {
      try {
        console.debug("downloading file", item)
    ...
    async Upload(e) {
      ...
      reader.onload = async function () {
        ...
        console.debug("file " + name + " uploaded with id " + id);
        e.target.value= null;
        me.Reload();
      }
