...
<template>
  ...
  <svg v-if="name === 'play'" width="16" height="16" viewBox="0 0 24 24">
    <path
      fill="#FFFFFB"
      d="M8 5.14v14.12L19 12.078L8 5.14ZM6 5v14h2V5H6ZM19 19H8V5h11v14Z"
    />
  </svg>

  <svg v-if="name === 'save'" width="16" height="16" viewBox="0 0 24 24">
    <path
      fill="#FFFFFB"
      d="M19 21H5V7h5V3h4v4h5v14Zm-2-2v-8H7v8h10Zm-4-6h2v2h-2v-2Z"
    />
  </svg>

  <svg v-if="name === 'red_exclamationpoint'" width="16" height="16" viewBox="0 0 24 24">
    <path
      fill="#FFFFFB"
      d="M12 21a9 9 0 1 1 9-9a9.01 9.01 0 0 1-9 9Zm0-16a7 7 0 1 0 7 7A7 7 0 0 0 12 5Zm1 11h-2v-2h2v2Zm0-4h-2V7h2v5Z"
    />
  </svg>
</template>
