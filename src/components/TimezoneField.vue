<template>
    <!-- <input type="text" :value="modelValue" ref="editfield" @input="$emit('update:modelValue', $event.target.value)"
        @blur="$emit('update:modelValue', $event.target.value)" /> -->
    <select name="timezone" id="timezone" @input="$emit('update:modelValue', $event.target.value)" :value="modelValue">
        ...
        <optgroup label="America">
            ...
            <option value="America/Argentina/ComodRivadavia" label="Argentina (ComodRivadavia)">Argentina
                (ComodRivadavia)
            </option>
