...
<style>
 .toolbox-node-findone {
  background: var(--ml-studio-findone-node-background-color);
  color: var(--ml-studio-findone-node-font-color);
}
</style>
<style scoped>
.node-findone {
