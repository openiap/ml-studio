<template>
  ...
  <v-text-field v-model="node.data.dims" label="Dimensions" required>
    <template v-slot:append>
      <v-tooltip text="Array of integers. Permutation pattern. Does not include the sample (batch) dimension. Index starts at 1. For instance, [2, 1] permutes the first and second dimensions of the input.">
