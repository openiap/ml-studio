...
<template>
  <div class="node-tf_util_shuffle">
    <div>{{ node.label }}</div>
...
<style>
.toolbox-node-tf_util_shuffle {
  background: #4107ad;
  color: #fffffb;
}
body.dark .toolbox-node-tf_util_shuffle {
  background: #4107ad6f;
}
</style>
<style scoped>
/* .vue-flow__node-tf_util_shuffle {
  background: #4107ad;
  color: #fffffb;
}
body.dark .vue-flow__node-tf_util_shuffle {
  background: #4107ad6f;
} */
.node-tf_util_shuffle {
  background: #4107ad;
  color: #fffffb;
  text-align: center;
