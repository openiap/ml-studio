<template>
  ...
  <v-text-field v-model="node.data.alpha" :rules="posetivrequired" label="Alpha" type="number" required>
    <template v-slot:append>
      <v-tooltip text="Float >= 0. Negative slope coefficient. Defaults to 1.0.">
