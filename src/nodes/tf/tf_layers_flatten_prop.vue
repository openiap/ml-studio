<template>
  ...
  <v-select clearable
  v-model="node.data.dataFormat"
  :items="[ {id: 'channelsFirst', name: 'channelsFirst'}, {id: 'channelsLast', name: 'channelsLast'}]"
  item-title="name"
  item-value="id"
  label="Data format"
  outlined required>
    <template v-slot:append>
      <v-tooltip text="Image data format: channelsLast (default) or channelsFirst.">
